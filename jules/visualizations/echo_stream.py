...
class EchoStreamVisualizer:
    ...
    def create(self, flagged_posts: List[Dict[str, Any]], all_posts: List[Dict[str, Any]]) -> str:
        ...
        if post_times:
            ...
            ax1.plot(post_times, echo_scores, 'o-', color='#e74c3c', 
                    linewidth=2, markersize=6, label='Echo Score')
            ...
            ax2.plot(post_times, hallucination_scores, 's-', color='#3498db',
                    linewidth=2, markersize=6, label='Hallucination Score')
            ...
            ax2.text(0.5, 0.5, 'No temporal data available',
                    ha='center', va='center', fontsize=14)
